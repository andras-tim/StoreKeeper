...
class TestAdminRights(CommonSessionTest):
    ...
    def test_admin_can_not_delete_itself(self):
        self.assertRequestAsAdmin("delete", "/users/%d" % Users.ADMIN["id"], expected_status_code=422)
...
class TestUserRights(CommonSessionTest):
    ...
    def test_user_can_not_add_new_user(self):
        self.assertRequest("post", "/users", data=Users.USER2.set(), expected_status_code=403)
    ...
    def test_user_can_not_update_another_user(self):
        self.assertRequest("put", "/users/%d" % Users.ADMIN["id"], data=Users.ADMIN.set(), expected_status_code=403)

    def test_user_can_not_delete_itself(self):
        self.assertRequest("delete", "/users/%d" % Users.USER1["id"], expected_status_code=403)
