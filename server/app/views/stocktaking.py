...
class StocktakingListView(BaseView):
    _model = Stocktaking
...
class StocktakingItemListView(BaseView):
...
class StocktakingCloseView(BaseView):
    ...
    def put(self, id: int):
        stocktaking = self._get_model_object(id=id)
        ...
        self._apply_quantity_changes(
            nested_model_objects=stocktaking_items,
        ...
        self._call_with_handle_errors(stocktaking.close_items, self._current_user)
