...
# -*- coding: utf-8 -*-
#
# StoreKeeper documentation build configuration file, created by
...
version = app.server.version_info.version
# The full version, including alpha/beta/rc tags.
release = app.server.version_info.release
...
latex_documents = [
  ('index', 'StoreKeeper.tex', 'StoreKeeper Documentation',
   'Andras Tim', 'manual'),
]
...
man_pages = [
    ('index', 'storekeeper', 'StoreKeeper Documentation',
     ['Andras Tim'], 1)
]
...
texinfo_documents = [
  ('index', 'StoreKeeper', 'StoreKeeper Documentation',
   'Andras Tim', 'StoreKeeper', 'One line description of project.',
   'Miscellaneous'),
]
